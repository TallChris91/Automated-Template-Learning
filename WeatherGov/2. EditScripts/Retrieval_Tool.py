...
with open(currentpath + '/Corpora/weather_new/Train_new2.data', 'rb') as f:
    traindata = f.readlines()
traindata = [l.decode('utf-8') for l in traindata]

with open(currentpath + '/Corpora/weather_new/Test_new2.data', 'rb') as f:
    testdata = f.readlines()
testdata = [l.decode('utf-8') for l in testdata]

with open(currentpath + '/Corpora/weather_new/Train_new2.text', 'rb') as f:
...
with open(currentpath + '/Corpora/weather_new/Test_Retrieval_Gaps.txt', 'wb') as f:
