...
with open(currentpath + '/Corpora/sportscasting/Train_2_new.data', 'rb') as f:
    traindata = f.readlines()
traindata = [l.decode('utf-8') for l in traindata]

with open(currentpath + '/Corpora/sportscasting/Test_2_new.data', 'rb') as f:
    testdata = f.readlines()
testdata = [l.decode('utf-8') for l in testdata]

with open(currentpath + '/Corpora/sportscasting/Train_2_new.text', 'rb') as f:
...
with open(currentpath + '/Corpora/sportscasting/Test_Retrieval_Gaps.txt', 'wb') as f:
